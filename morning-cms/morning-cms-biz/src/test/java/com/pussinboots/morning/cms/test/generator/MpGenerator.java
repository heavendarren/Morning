package com.pussinboots.morning.cms.test.generator;
...
public class MpGenerator {
	...
	public static void main(String[] args) {
		...
		strategy.setInclude(new String[] { "cms_organization"}); // 需要生成的表
		...
		pc.setParent("com.pussinboots.morning.cms.modules");
		pc.setModuleName("administrator");
