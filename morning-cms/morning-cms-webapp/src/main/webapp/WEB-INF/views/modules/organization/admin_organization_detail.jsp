...
<div class="wrapper wrapper-content animated fadeInRight">
  ...
  <c:forEach items="${organizationVOs}" var="organizationVO">
    <div class="col-sm-4">
      <div class="ibox">
        <div class="ibox-title"><c:if test="${organizationVO.status eq '0' }"> <span class="label label-danger pull-right">冻结</span></c:if>
          <h5>编号-${organizationVO.organizationId } - ${organizationVO.organizationName }</h5>
        </div>
        <div class="ibox-content">
          <div class="team-members"> <a href="${ctx}/administrator/organization/${organizationVO.organizationId }/detail"><c:forEach items="${organizationVO.users }" var="user"><img src="${ctximg}/${user.picImg}" alt="头像加载中..." class="img-circle"> </c:forEach> </a></div>
          <h4>组织简介</h4>
