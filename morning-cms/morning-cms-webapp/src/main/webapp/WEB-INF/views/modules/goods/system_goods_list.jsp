                                ...
                                <div class="example-wrap">
                                    <div class="example">
                                        ...
                                        <tr>
                                            ...
                                            <a class="remove m-l-sm text-primary" href="javascript:void(0)" onclick="member_show('${goods.goodsName}','${ctx}/system/goods/list','${goods.goodsId}','spec','900','600')" title="日志">
