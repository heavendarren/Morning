                    ...
                    <div class="col-sm-12">
                        <div class="example-wrap">
                            <div class="example">
                                ...
                                <tbody>
                                <c:forEach items="${userLoginLogList}" var="userLoginLogList">
                                <tr>
                                    <td><fmt:formatDate value="${userLoginLogList.loginTime}" pattern="yyyy/MM/dd HH:mm" /></td>
                                    <td>${userLoginLogList.userIp}</td>
                                    <td>${userLoginLogList.operatingSystem}</td>
                                    <td>${userLoginLogList.browser}</td>
                                </tr>
                                </c:forEach>
                                </tbody>
							</table>
