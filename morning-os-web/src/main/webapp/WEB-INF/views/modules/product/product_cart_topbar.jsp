...
<c:if test="${not empty cartVO}">
  <ul class="cart-list">
    <c:forEach items="${cartVO.shoppingCartVOs}" var="shoppingCart">
      <li>
        <div class="cart-item clearfix first"><a class="thumb" href="${ctx}/detail/${shoppingCart.productNumber}"><img alt="${shoppingCart.name}" src="${ctximg}/${shoppingCart.picImg}" width="60" height="60"></a><a class="name" href="${ctx}/detail/${shoppingCart.productNumber}">${shoppingCart.name}
