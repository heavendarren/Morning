  ...
  <div class="container-fluid">
    <div class="buy-succ-box clearfix">
      <div class="goods-content" id="J_goodsBox">
        <div class="goods-img"> <a href="${ctx }/item/${shoppingCartVO.productNumber}"><img src="${ctximg}/${shoppingCartVO.picImg}" title="${shoppingCartVO.name }" width="110" height="110"> </a></div>
      ...
      <div class="actions"> <a href="${ctx}/index.html" class="btn btn-line-gray" >继续购物</a> <a href="${ctx }/cart/" class="btn btn-primary">去购物车结算</a> </div>
    </div>
    <!-- 买购物车中商品的人还买了 -->
