...
<link rel="stylesheet" href="${ctxsta}/web/css/order-confirm.css">
</head>
<body>
<!-- 轮播top菜单导航引入 -->
          ...
          <ul>
            ...
            <li class="clearfix">
              ...
              <div class="content"> 
              	...
              	${orderProduct.name}&nbsp;${orderProduct.productSpecName} <br>
              	</c:forEach>
              </div>
            </li>
            <li class="clearfix">
        ...
        <div class="payment-box ">
          ...
          <div class="payment-body">
            ...
            <div class="event-desc">
              ...
              <a href="http://www.mi.com/c/payrule/" class="more" target="_blank">了解更多&gt;</a> </div>
          </div>
        </div>
        <div class="payment-box ">
          <div class="payment-header clearfix">
...
<myfooter> 
  ...
  <script src="${ctxsta}/web/js/order.js"></script>   
</myfooter>
</body>
</html>