...
<link rel="stylesheet" href="${ctxsta}/web/css/checkout.css">
</head>
<body>
<!-- 轮播top菜单导航引入 -->
  ...
  <div class="container-fluid">
    ...
    <div class="section section-goods">
      <div class="section-header clearfix">
        ...
        <div class="more"> <a href="${ctx}/cart/">返回购物车<i class="iconfont"><i class="glyphicon glyphicon-chevron-right"></i></i></a> </div>
      </div>
      <div class="section-body">
        ...
        <c:forEach items="${cartVO.shoppingCartVOs }" var="shoppingCart">
          <li class="clearfix">
            ...
            <div class="col col-name"> <a href="${ctx }/item/${shoppingCart.productNumber}" target="_blank"> ${shoppingCart.name} <c:forEach items="${shoppingCart.specificationName }" var="specificationName">&nbsp;${specificationName}</c:forEach></a> </div>
