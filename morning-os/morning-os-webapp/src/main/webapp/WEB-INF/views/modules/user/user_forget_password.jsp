        	...
        	<div class="reg-box retrieve-psw" id="verifyCheck" style="margin-top:20px;">
            	<div class="part1">                	
                    ...
                    <div class="item col-xs-12">
                        <span class="intelligent-label f-fl">&nbsp;</span>    
                        <div class="f-fl item-ifo">
                           <a href="javascript:;" class="btn btn-blue f-r3" id="btn_Pswpart1">找回密码</a>                         
                        </div>
                    </div> 
                </div>
                <div class="part2" style="display:none">
                    ...
                    <div class="item col-xs-12" >
                        ...
                        <div class="f-fl item-ifo">
                            ...
                            <span class="btn btn-gray f-r3 f-ml5 f-size13" id="verifyYz" data-type="1" style="width:97px;">发送验证码</span>
                    ...
                    <div class="item col-xs-12">
                        <span class="intelligent-label f-fl">&nbsp;</span>    
                        <div class="f-fl item-ifo">
                           <a href="javascript:;" class="btn btn-blue f-r3" id="btn_Pswpart2">提交</a>                         
                        </div>
                    </div> 
                </div>
                <div class="part3" style="display:none">
                    ...
                    <div class="item col-xs-12">
                        <span class="intelligent-label f-fl">&nbsp;</span>    
                        <div class="f-fl item-ifo">
                           <a href="javascript:;" class="btn btn-blue f-r3" id="btn_Pswpart3">确定</a>                         
                        </div>
                    </div>
                </div>  
