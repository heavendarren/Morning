package com.pussinboots.morning.os.test.generator;
...
* 类名称：MpGenerator   
* 类描述：Mybatis-plus代码生成器   
* 创建人：陈星星   
* 创建时间：2017年1月31日 下午12:34:52
 */
public class MpGenerator {
	...
	public static void main(String[] args) {
		...
		strategy.setInclude(new String[] { "os_order", "os_order_product","os_order_shipment","os_order_status"}); // 需要生成的表
		...
		pc.setParent("com.pussinboots.morning.os.modules");
