...
public class Email extends Model<Email> {
	...
	public Email(Long emailSign, String userEmail, Integer emailType, Date createTime, Date startTime,
			Date endTime, Integer sendStatus, String captcha, String emailSubject,String emailContent) {
		super();
