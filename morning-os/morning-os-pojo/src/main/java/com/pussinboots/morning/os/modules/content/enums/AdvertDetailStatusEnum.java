...
*
 */
public enum AdvertDetailStatusEnum {
	...
	private AdvertDetailStatusEnum(Integer status, String stateInfo) {
		this.status = status;
	...
	public static AdvertDetailStatusEnum stateOf(int index) {
		for (AdvertDetailStatusEnum statusEnum : values()) {
