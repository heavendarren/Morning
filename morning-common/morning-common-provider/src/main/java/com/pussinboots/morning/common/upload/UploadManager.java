package com.pussinboots.morning.common.upload;
...
import com.pussinboots.morning.common.util.ImageUtils;
...
public class UploadManager {
	 ...
	 * @return 
	 */
	public static Map<String, Object> upload(HttpServletRequest request, MultipartFile avatarFile, String avatarData,
		...
		returnMap.put("savaPath", getSavaDir(dir, belong, newFileName));
