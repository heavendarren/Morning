    ...
    <div class="middle-box text-center lockscreen animated fadeInDown">
        <div>
            ...
            <div class="member_content">
              <ul>
               <li><label class="label_name">姓名：</label><span class="name">${user.userName}</span></li>
               ...
               <li><label class="label_name">身份证：</label><span class="name">${user.userIdentity}</span></li>
               <li><label class="label_name">注册时间：</label><span class="name"><fmt:formatDate value="${user.createDate}" pattern="yyyy/MM/dd HH:mm" /></span></li>
               <li><label class="label_name">积分：</label><span class="name">${user.userPoint}</span></li>
               <li><label class="label_name">等级：</label><span class="name">${user.sex}</span></li>
              </ul>
            </div>
        </div>
    </div>
