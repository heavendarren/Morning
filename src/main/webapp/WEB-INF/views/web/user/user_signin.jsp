        	...
        	<div class="reg-box" id="verifyCheck" style="margin-top:20px;">
            	...
            	<form method="post" id="verifyUser">                	
                    <div class="item col-xs-12">
                        ...
                        <div class="f-fl item-ifo">
                            <input type="text" name="user.loginName" maxlength="20" class="txt03 f-r3 required" tabindex="1" data-valid="isNonEmpty||between:3-20||isUname" data-error="用户名不能为空||用户名长度3-20位||只能输入中文、字母、数字、下划线，且以中文或字母开头" id="adminNo" /><span class="ie8 icon-close close hide"></span>
                    ...
                    <div class="item col-xs-12">
                        ...
                        <div class="f-fl item-ifo">
                            <input type="text" name="user.telephone" class="txt03 f-r3 required" keycodes="tel" tabindex="2" data-valid="isNonEmpty||isPhone" data-error="手机号码不能为空||手机号码格式不正确" maxlength="11" id="phone" /> 
                    ...
                    <div class="item col-xs-12">
                        ...
                        <div class="f-fl item-ifo">
                            <input type="password" name="user.loginPassword" id="password" maxlength="20" class="txt03 f-r3 required" tabindex="3" style="ime-mode:disabled;" onpaste="return  false" autocomplete="off" data-valid="isNonEmpty||between:6-20||level:2" data-error="密码不能为空||密码长度6-20位||该密码太简单，有被盗风险，建议字母+数字的组合" /> 
                    ...
                    <div class="item col-xs-12">
                        ...
                        <div class="f-fl item-ifo">
                            <input type="text" name="registerCode" maxlength="4" class="txt03 f-r3 f-fl required" tabindex="4" style="width:167px" id="randCode" data-valid="isNonEmpty" data-error="验证码不能为空" /> 
                            <span class="ie8 icon-close close hide"></span>
                            <label class="f-size12 c-999 f-fl f-pl10">
                            	<img src="${ctx}/captcha-image.jpg" id="kaptchaImage" />                   
                            </label>                        
                    ...
                    <div class="message item col-xs-12" style="height:auto">
                ...
                <div class="part2" style="display:none">
                    ...
                    <div class="item col-xs-12">
                        <span class="intelligent-label f-fl"><b class="ftx04">*</b>验证码：</span>    
                        <div class="f-fl item-ifo">
                            <input type="text" maxlength="6" name="emailCaptcha" id="verifyNo" class="txt03 f-r3 f-fl required" tabindex="4" style="width:167px" data-valid="isNonEmpty||isInt" data-error="验证码不能为空||请输入6位数字验证码" /> 
                           	<span class="btn btn-gray f-r3 f-ml5 f-size13" id="time_box" disabled style="width:97px;display:none;">发送验证码</span>
                            <span class="btn btn-gray f-r3 f-ml5 f-size13" id="verifyYz" data-type="0" style="width:97px;">发送验证码</span>
                ...
                <div class="part3" style="display:none">
                	<div class="item col-xs-12 f-mb20">
                        <span class="intelligent-label f-fl"><b class="ftx04">*</b>真实姓名：</span>    
                        <div class="f-fl item-ifo">
                            <input type="text" name="user.userName" maxlength="10" class="txt03 f-r3 required" tabindex="1" data-valid="isNonEmpty||between:2-10||isZh" data-error="真实姓名不能为空||真实姓名长度2-10位||只能输入中文" id="adminNo" />   
                            <span class="ie8 icon-close close hide"></span>                         
                            <label class="icon-sucessfill blank hide"></label>
                    ...
                    <div class="item col-xs-12">
                        ...
                        <div class="f-fl item-ifo">
                            <input type="text" name="user.userIdentity" class="txt03 f-r3 required" tabindex="2" data-valid="isNonEmpty||isCard" data-error="身份证号不能为空||身份证号码格式不正确" maxlength="18" id="phone" />    
                            <span class="ie8 icon-close close hide"></span>                        
                            <label class="icon-sucessfill blank hide"></label>
                ...
                <div class="part4 text-center" style="display:none">
                	<h3></h3>
                    <p class="c-666 f-mt30 f-mb50">页面将在 <strong id="times" class="f-size18">10</strong> 秒钟后，跳转到 <a href="${ctx}/user/userLogin" class="c-blue">登陆界面</a></p>
                </div>          
            </div>
        </div>
    </div>
