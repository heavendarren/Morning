...
$(function(){	
	...
	$("#btn_part2").click(function(){
		...
		$.ajax({
			...
			data:{emailCaptcha:emailCaptcha,type:type },
			dataType:"json",
			success:function(result){
				if(result.success==true){
					$(".part2").hide();
...
$(function(){	
	$("#btn_login").click(function(){
		...
		var modulus = $("#password").attr("data-modulus"),
			...
			name = $("input[name='user.loginName']").val();
	    ...
	    $.ajax({
			type: "POST",
			url: baselocation+'/user/userLogin',
			data: {"user.loginName":name,"user.loginPassword":password},
			dataType: "json",
			success:function(result){
				if(result.success==true){
					$(".message").hide();
					...
					$(".message").show();
					$(".message").children("label").text(result.message);
					$("input[name='user.email']").val(result.entity);
				}
			}
		})
	});
...
$(function(){	
	...
	$("#btn_Pswpart1").click(function(){
	    ...
	    $.ajax({
			...
			data: {registerCode:registerCode,email:email},
			dataType: "json",
			success:function(result){
				if(result.success==true){
					$(".part1").hide();
	...
	$("#btn_Pswpart3").click(function(){	
	    ...
	    $.ajax({
			...
			data: {loginPassword:loginPassword,emailCaptcha:emailCaptcha},
			dataType: "json",
			success:function(result){
				if(result.success==true){
